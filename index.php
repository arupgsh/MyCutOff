			...
			<div class="span3">
				<div class="well">
					<ul class="nav nav-list">
						...
						<li>
							<a href="./store/flipkart.php">Flipkart Offers</a>
						</li>
						<li>
							<a href="./store/snapdeal.php">SnapDeal Offers</a>
						</li>
						<li>
							<a href="./store/amazon.php">Amazon.in Offers</a>
						</li>
						<li>
							<a href="./store/jabong.php">Jabong Offers</a>
						</li>
						<li>
							<a href="./store/infibeam.php">Infibeam Offers</a>
						</li>
						<li>
							<a href="./store/ebay.php">Ebay.in Offers</a>
						</li>
					</ul>
				</div>
